...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_ac126a33_argocd_dev3argocd_a687_4cf2c3f1d9c523fc" {
  tags = {
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_ac126a33_default_dev3ingre_dd09_84c4412c7a5c5bb9" {
  tags = {
    "ingress.k8s.aws/cluster"              = "eks-data-dev-3"
    "ingress.k8s.aws/resource"             = "LoadBalancer"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_ac126a33_istiosystem_dev3i_f8f0_9e5fcac98f550afb" {
  tags = {
    "ingress.k8s.aws/cluster"              = "eks-data-dev-3"
    "ingress.k8s.aws/resource"             = "LoadBalancer"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_airpr_extractor_light4j_external_0b44b4a16dcc459a" {
  tags = {
    Billing        = "Extractor"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_airpr_extractor_light4j_f1dff3cee26ff8cd" {
  tags = {
    Billing        = "Extractor"
    Billing-Detail = "Content-Extractor"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_airpr_extractor_light4j_internal_9cc8bb0e474d54b2" {
  tags = {
    Billing        = "Extractor"
    Billing-Detail = "Content-Extractor"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_airpr_extractor_light4j_sl_54cdc2d5db7b9f6d" {
  access_logs {
    bucket = ""
  }
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_airpr_visitor_estimation_0e46e8ae62a2052d" {
  tags = {
    Billing        = "Crawler"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_analyst_es_5x_7575abbee24bce0d" {
  tags = {
    Billing        = "Analyst"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_analytics_es_5x_7af6b8bcd507e73b" {
  tags = {
    Billing        = "Analyst"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_analytics_es_6x_1627caec887b817e" {
  tags = {
    Billing        = "Analyst"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_crawler_es_6x_4d921cbee6fc5ad5" {
  tags = {
    Billing        = "Crawler"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_crawler_es_client_6b792cfb976f9e9b" {
  tags = {
    Billing        = "Crawler"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_crawler_es_util_6fd6b370b0d0c38a" {
  tags = {
    Billing        = "Crawler"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_crawler_percolates_5x_cc3a31f4746d1582" {
  tags = {
    Billing        = "Crawler-5x"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_crawler_percolates_fe_5x_60130645376ab7be" {
  tags = {
    Billing        = "Crawler-5x"
    Billing-Detail = "Crawler-Percolates-5x"
  }
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_crawler_prod_es_6x_712e6df24692bb95" {
  tags = {
    Billing        = "Crawler"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_f03c0651_default_prod1ingr_7563_ff0bb38c663e7d18" {
  tags = {
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_k8s_default_dev2ingr_7be0a1ceb0_89894bc1f0fe2c35" {
  tags = {
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_k8s_default_prod3ing_75a5f4c190_650a139e70c846e1" {
  tags = {
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_k8s_istiosys_istioing_527dc2303c_ac7b79eb7e63bd31" {
  tags = {
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_luminati_proxy_manager_elb_d390b92366998397" {
  tags = {
    Billing        = "Crawler"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_monitoring_es_5x_5a52e7ef4851c4c9" {
  tags = {
    Billing        = "Crawler"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_nlp_services_2_aca9adc3123f9c84" {
  tags = {
    Billing        = "Crawler"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_pixel_alb_af955ca7e396cd5c" {
  tags = {
    Billing        = "Pixel"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_prod_crawler_master_a826f6d7b758bcb1" {
  tags = {
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_splash_internal_84c86d80f6b76cf3" {
  tags = {
    Billing        = "Crawler"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_staging_es_5x_48401b361793827e" {
  tags = {
    Billing        = "Crawler"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_twitter_search_dev_47a97607e59a1bd4" {
  tags = {
    Billing        = "Crawler"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_app_twitter_search_f8e973a8125006d8" {
  tags = {
    Billing        = "Crawler"
    Billing-Detail = "Twitter-Search"
  }
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_net_ad9177437a8aa4954aabe013705ffd8d_d4c8ae7671f7ba6f" {
  tags = {
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_net_eks_data_prod_external_9a1b7bb4459ec04a" {
  access_logs {
    bucket = ""
  }
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_net_k8s_ingressn_nginxing_e912559390_f6fe4796770dd9a0" {
  tags = {
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_net_luminati_proxy_staging_elb_1d2362322db2ae72" {
  tags = {
    Billing        = "Crawler"
    Billing-Detail = "Crawler-Luminatti-Proxy-Manager"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_net_r_server_1c99945fe8b0ce33" {
  tags = {
    Billing        = "Extractor"
...
resource "aws_alb" "arn_aws_elasticloadbalancing_us_east_1_484375727565_loadbalancer_net_selenium_hub_elb_7308aef84138b0d6" {
  tags = {
    Billing        = "Crawler"
...
resource "aws_alb" "bert_inference_internal" {
  tags = {
    Billing        = "data"
...
resource "aws_alb" "visitorestimation_prod_2" {
  tags = {
    Billing                             = "Analyst"
